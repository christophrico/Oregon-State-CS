...
main( int argc, char *argv[ ] )
{
	...
	//fprintf( stderr, "%8d\t%4d\t%10d\t%10.3lf GigaMultsPerSecond\n",
		//LOCAL_SIZE, LOCAL_SIZE, NUM_WORK_GROUPS, (float)GLOBAL_SIZE/(time1-time0)/1000000000. );

    //write to csv
    if(print_data)
			fprintf(datafile, "%s,%d,%d,%d,%13.6f,%13.6f,%lf\n", CL_FILE_NAME, LOCAL_SIZE, GLOBAL_SIZE, NUM_WORK_GROUPS, expected, actual, (double)GLOBAL_SIZE/(time1-time0)/1000000000.);
    fclose(datafile);
